            ...
            <div class="page-wrap">
                ...
                <table class="table table-bordered  mb-15 mt-15">
                    ...
                    <tr class="cen">
                        ...
                        <td><button class="btn btn-info JopenPanel mr-10">编辑</button></td>
                    </tr>
                    <tr class="cen">
...
<div class="dialog">
    <div class="dialog-hd">
        <strong class="lt-title"><?php echo ($username0); ?></strong>
        <a class="rt-operate icon-remove JclosePanel" title="关闭"></a>
    </div>
    <div class="dialog-bd">
        <form action="/index.php/Admin/LoginAdmin/userEdit2" method="post">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="password" name="wechat">
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-12">
                    <label for="password2">Introduction</label>
                    <input type="text" class="form-control" id="password2" name="introduction">
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-12">
